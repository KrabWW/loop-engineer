...
The architecture is currently in specification review. Runtime code and imported lifecycle scripts will be added only after their contracts, provenance, and licensing are verified.
